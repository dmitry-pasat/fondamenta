...
?><div class='wpc-condition-wrap'>
	...
	<span class='wpc-condition-field-wrap'><?php
		...
		$condition_field_args = array(
			'type' => 'select',
			'name' => '_product_conditions[' . absint( $wp_condition->group ) . '][' . absint( $wp_condition->id ) . '][condition]',
	...
	<span class='wpc-operator-field-wrap'><?php
		...
		$operator_field_args = array(
			'type' => 'select',
			'name' => '_product_conditions[' . absint( $wp_condition->group ) . '][' . absint( $wp_condition->id ) . '][operator]',
